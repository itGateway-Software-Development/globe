      ...
      <div class="col-12 col-sm-12 col-md-12 col-xl-12 mb-5" data-aos="fade-up">
        <div class="blcok-banner">
          <div class="responsive-image">
            <img src="../../assets/images/gadget/banner.png" alt="" />
          </div>
          <div class="image-content">
            <h4>Keyboard & Mouse List</h4>
    ...
    const productList = ref([
      {
        id: 1,
        type: "gadget",
        name: "Lenovo Keyboard & Mouse",
        price: "20",
        stock: "20",
        warrenty: "3",
        img: require("@/assets/images/gadget/2.jpg"),
        hoverimg: require("@/assets/images/gadget/1.jpg"),
      },
      {
        id: 2,
        type: "gadget",
        ...
        stock: "20",
        warrenty: "3",
        img: require("@/assets/images/gadget/3.jpg"),
        hoverimg: require("@/assets/images/gadget/4.jpg"),
      },
      {
        id: 3,
        type: "gadget",
        ...
        stock: "20",
        warrenty: "3",
        img: require("@/assets/images/gadget/5.jpg"),
        hoverimg: require("@/assets/images/gadget/6.jpg"),
      },
      {
        id: 4,
        type: "gadget",
        ...
        hoverimg: require("@/assets/images/gadget/8.jpg"),
      },
    ]);
