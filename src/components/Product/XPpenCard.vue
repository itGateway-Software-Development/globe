<template>
  <div v-if="tab == 'DD'" class="row vm gap-3 content-wrapper">
    <div
  ...
  <div class="row vm gap-3 content-wrapper" v-if="tab == 'DT'">
    <div
      class="card col-12 col-md-6 col-lg-3"
  ...
  <div class="row vm gap-3 content-wrapper" v-if="tab == 'accessories'">
    <div
      class="card col-12 col-md-6 col-lg-3"
    ...
    const AllGadget = [
      {
        id: "1",
        name: "XP Pen",
        spec: "XP-pen 15.6 inch dreawing display",
        price: "48",
        img: [
          { url: require("@/assets/xp-pen/xp-pen.jpg"), status: "primary_img" },
