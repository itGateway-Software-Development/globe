  ...
  <div class="row vm gap-3 content-wrapper" v-if="tab == 'conferencing'">
    ...
    <div>
      <button
        v-if="!isViewAll4"
        class="btn main-btn vm mt-5"
        @click="viewMoreItem('conferencing')"
      >
        View More
      </button>
      <button v-else class="btn main-btn vm mt-5">View All</button>
    ...
    const AllGadget = [
      {
        ...
        spec: "Asus Rog Gaming Monitor",
        price: "48",
        img: [
          {
            url: require("@/assets/portable/monitor.png"),
            status: "primary_img",
          },
